error id: scala/util/Failure.
file:///C:/Users/dr_sh/OneDrive/Desktop/CTRL%20ALT%20CHATBOT/CTRL%20ALT%20CHATBOT/src/chatbot.scala
empty definition using pc, found symbol in pc: scala/util/Failure.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -java/io/scala/util/Failure.
	 -java/io/scala/util/Failure#
	 -java/io/scala/util/Failure().
	 -scala/io/StdIn.scala.util.Failure.
	 -scala/io/StdIn.scala.util.Failure#
	 -scala/io/StdIn.scala.util.Failure().
	 -scala/util/Failure.
	 -scala/util/Failure#
	 -scala/util/Failure().
	 -scala/Predef.scala.util.Failure.
	 -scala/Predef.scala.util.Failure#
	 -scala/Predef.scala.util.Failure().
offset: 31597
...
def runChatbot(
  ...
  def loop(currentState: ChatbotState): Unit = {
    ...
    Try(readLine()) match {
        ...
        // case Failure(ex) => // OLD
        case scala.util.Failu@@re(ex) => // NEW
