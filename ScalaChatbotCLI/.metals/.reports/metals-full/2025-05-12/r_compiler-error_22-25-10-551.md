...
### scala.MatchError: TypeDef(ChatbotState,Tuple(List(Ident(InteractionLog), Ident(Int), AppliedTypeTree(Ident(Option),List(Ident(QuizSessionState))), Ident(UserPreferences), Ident(LastActionContext), Ident(CurrentUser)))) (of class dotty.tools.dotc.ast.Trees$TypeDef)
