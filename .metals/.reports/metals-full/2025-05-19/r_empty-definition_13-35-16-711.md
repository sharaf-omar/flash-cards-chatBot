error id: file:///C:/Users/dr_sh/OneDrive/Desktop/CTRL%20ALT%20CHATBOT/CTRL%20ALT%20CHATBOT/CTRL%20ALT%20CHATBOT/ScalaChatbotGUI/src/main/scala/ChatbotEngine.scala:contains.
...
non-local guesses:
	 -java/io/userAnswerProcessed/contains.
	 -java/io/userAnswerProcessed/contains#
	 -java/io/userAnswerProcessed/contains().
	 -com/github/tototoshi/csv/userAnswerProcessed/contains.
	 -com/github/tototoshi/csv/userAnswerProcessed/contains#
	 -com/github/tototoshi/csv/userAnswerProcessed/contains().
	 -userAnswerProcessed/contains.
	 -userAnswerProcessed/contains#
	 -userAnswerProcessed/contains().
	 -scala/Predef.userAnswerProcessed.contains.
	 -scala/Predef.userAnswerProcessed.contains#
	 -scala/Predef.userAnswerProcessed.contains().
offset: 25893
...
object ChatbotEngine {
  ...
  def evaluateQuizAnswer(userAnswerRaw: String, choices: List[String], correctAnswerText: String): String = {
    ...
    val chosenAnswerTextOpt: Option[String] = 
      ...
      }else if(userAnswerProcessed.co@@ntains("hint") || userAnswerProcessed.contains("hint")) 
