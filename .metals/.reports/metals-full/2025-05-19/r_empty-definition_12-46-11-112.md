error id: file:///C:/Users/dr_sh/OneDrive/Desktop/CTRL%20ALT%20CHATBOT/CTRL%20ALT%20CHATBOT/CTRL%20ALT%20CHATBOT/ScalaChatbotGUI/src/main/scala/ChatbotEngine.scala:`<none>`.
...
non-local guesses:
	 -java/io/exampleTemplates.
	 -com/github/tototoshi/csv/exampleTemplates.
	 -exampleTemplates.
	 -scala/Predef.exampleTemplates.
offset: 37684
            ...
            case Some(("explained", conceptName)) =>
              explanations.get(conceptName) match {
                case Some((expl1, expl2, exampleText, note)) =>
                  ...
                  if (exampleText.nonEmpty) exampleTemplates(Random.nextInt(examp@@leTemplates.length)).replace("{concept}", conceptName).replace("{response}", exampleText)
