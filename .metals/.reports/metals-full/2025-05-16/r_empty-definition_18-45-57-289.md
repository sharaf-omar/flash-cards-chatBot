error id: file:///C:/Users/dr_sh/OneDrive/Desktop/CTRL%20ALT%20CHATBOT/ScalaChatbotCLI/src/main/scala/chatbot.scala:`<none>`.
file:///C:/Users/dr_sh/OneDrive/Desktop/CTRL%20ALT%20CHATBOT/ScalaChatbotCLI/src/main/scala/chatbot.scala
...
offset: 346
uri: file:///C:/Users/dr_sh/OneDrive/Desktop/CTRL%20ALT%20CHATBOT/ScalaChatbotCLI/src/main/scala/chatbot.scala
text:
```scala
import java.io._
...
val baseDir = "data/"
  val explanationsPath = s"${baseDir}explanation@@s.csv"
  ...
  def determineIntent(tokens: List[String], rawInput: String): IntentInfo = {
    ...
    if (extractedName.isDefined && (baseIntent == "unknown" || baseIntent == "greeting")) {
        ...
        (baseIntent, baseConcepts, baseLangOpt, extractedName) // Pass along extractedName even if other intent found
    }
  }
